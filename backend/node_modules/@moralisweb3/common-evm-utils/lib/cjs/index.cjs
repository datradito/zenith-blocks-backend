...
var EvmTradeCollection = /** @class */ (function () {
    function EvmTradeCollection(input) {
        ...
        this.result = input.result ? input.result.map(function (item) { return EvmTrade.create(item); }) : undefined;
    }
    ...
    EvmTradeCollection.fromJSON = function (json) {
        var input = {
            ...
            cursor: json.cursor,
            result: json.result ? json.result.map(function (item) { return EvmTrade.fromJSON(item); }) : undefined,
        };
...
var EvmErc20TransfersResponse = /** @class */ (function () {
    function EvmErc20TransfersResponse(input) {
        this.cursor = input.cursor;
        this.result = input.result ? input.result.map(function (item) { return EvmErc20Transfer.create(item); }) : undefined;
    }
    ...
    EvmErc20TransfersResponse.fromJSON = function (json) {
        var input = {
            cursor: json.cursor,
            result: json.result ? json.result.map(function (item) { return EvmErc20Transfer.fromJSON(item); }) : undefined,
        };
...
function deserializeRequest$n(jsonRequest) {
    return {
        ...
        fromDate: jsonRequest.fromDate,
        toDate: jsonRequest.toDate,
        addresses: commonCore.maybe(jsonRequest.addresses, function (addresses) { return addresses.map(function (address) { return EvmAddress.create(address); }); }),
        cursor: jsonRequest.cursor,
        limit: jsonRequest.limit,
        disableTotal: jsonRequest.disableTotal,
    };
...
function deserializeResponse$i(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (approval) {
        return Erc20Approval.create(__assign(__assign({}, commonCore.toCamelCase(approval)), { chain: EvmChainResolver.resolve(request.chain, core), tokenDecimals: Number(approval.token_decimals) }));
    });
}
function serializeRequest$i(request, core) {
    var _a, _b, _c, _d;
...
function deserializeResponse$h(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (burn) {
        return Erc20Burn.create(__assign(__assign({}, commonCore.toCamelCase(burn)), { chain: EvmChainResolver.resolve(request.chain, core), tokenDecimals: Number(burn.token_decimals) }));
    });
}
function serializeRequest$h(request, core) {
    var _a, _b, _c, _d;
...
function deserializeResponse$f(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (mint) {
        return Erc20Mint.create(__assign(__assign({}, commonCore.toCamelCase(mint)), { chain: EvmChainResolver.resolve(request.chain, core), tokenDecimals: Number(mint.token_decimals) }));
    });
}
function serializeRequest$f(request, core) {
    var _a, _b, _c, _d;
...
exports.EvmErc20Transfer = EvmErc20Transfer;
exports.EvmErc20TransfersResponse = EvmErc20TransfersResponse;
...
exports.GetErc20TransfersOperation = GetErc20TransfersOperation;
...
exports.getErc20ApprovalsOperation = getErc20ApprovalsOperation;
exports.getErc20BurnsOperation = getErc20BurnsOperation;
exports.getErc20MintsOperation = getErc20MintsOperation;
exports.getErc20TransfersOperation = getErc20TransfersOperation;
...
exports.searchNFTsOperation = searchNFTsOperation;
